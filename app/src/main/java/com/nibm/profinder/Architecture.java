...
public class Architecture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Pro> options = new FirebaseRecyclerOptions
                .Builder<Pro>().setQuery(FirebaseDatabase.getInstance().getReference().child("Users").orderByChild("category").equalTo("Architecture"), Pro.class).build();
        ...
        categories.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Architecture.this, Categories.class);
